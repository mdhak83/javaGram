 ...
 * <pre>
 ...
 10           19.210              {@link ApiErrorExponentialBackoff#maxElapsedTimeMillis}
 * </pre>
 *
 * <p>
...
public class ApiErrorExponentialBackoff {
    ...
    /** The default maximum back off time in milliseconds (30 sec). */
    public static final int DEFAULT_MAX_INTERVAL_MILLIS = 30000;

    /** The default maximum elapsed time in milliseconds (5 minutes). */
    public static final int DEFAULT_MAX_ELAPSED_TIME_MILLIS = 300000;
    ...
    /**
     * The maximum elapsed time after instantiating {@link ApiErrorExponentialBackoff} or calling
     ...
     * </ul>
     */
    public ApiErrorExponentialBackoff() {
        this(new Builder());
    }
     ...
     */
    protected ApiErrorExponentialBackoff(Builder builder) {
     ...
     *
     * <p>
     * If the time elapsed since an {@link ApiErrorExponentialBackoff} instance is created goes past the
    ...
    /**
     * Returns the elapsed time in milliseconds since an {@link ApiErrorExponentialBackoff} instance is
     * created and is reset when {@link #reset()} is called.
     *
     * <p>
    ...
    /**
     * Builder for {@link ApiErrorExponentialBackoff}.
     *
     * <p>
     * Implementation is not thread-safe.
     * </p>
    ...
    public static class Builder {
        ...
        /**
         * The maximum elapsed time in milliseconds after instantiating {@link ApiErrorExponentialBackoff} or
        ...
        /** Builds a new instance of {@link ApiErrorExponentialBackoff}. */
        public ApiErrorExponentialBackoff build() {
            return new ApiErrorExponentialBackoff(this);
        }
