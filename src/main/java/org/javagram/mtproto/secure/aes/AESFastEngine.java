package org.javagram.mtproto.secure.aes;

import org.javagram.mtproto.secure.KeyParameter;
...
public class AESFastEngine {
    ...
    */
    ...
    private int[][] generateWorkingKey(
        ...
        int[][] W = new int[this.ROUNDS + 1][4];   // 4 words in a block
    ...
    public void init(
            ...
            this.WorkingKey = generateWorkingKey(params.getKey(), forEncryption);
    ...
    private void encryptBlock(int[][] KW) {
        ...
        while (r < this.ROUNDS - 1) {
            r0 = T0[this.C0 & 255] ^ T1[(this.C1 >> 8) & 255] ^ T2[(this.C2 >> 16) & 255] ^ T3[(this.C3 >> 24) & 255] ^ KW[r][0];
            r1 = T0[this.C1 & 255] ^ T1[(this.C2 >> 8) & 255] ^ T2[(this.C3 >> 16) & 255] ^ T3[(this.C0 >> 24) & 255] ^ KW[r][1];
            r2 = T0[this.C2 & 255] ^ T1[(this.C3 >> 8) & 255] ^ T2[(this.C0 >> 16) & 255] ^ T3[(this.C1 >> 24) & 255] ^ KW[r][2];
            r3 = T0[this.C3 & 255] ^ T1[(this.C0 >> 8) & 255] ^ T2[(this.C1 >> 16) & 255] ^ T3[(this.C2 >> 24) & 255] ^ KW[r++][3];
    ...
    private void decryptBlock(int[][] KW) {
        ...
        while (r > 1) {
            r0 = Tinv0[this.C0 & 255] ^ Tinv1[(this.C3 >> 8) & 255] ^ Tinv2[(this.C2 >> 16) & 255] ^ Tinv3[(this.C1 >> 24) & 255] ^ KW[r][0];
            r1 = Tinv0[this.C1 & 255] ^ Tinv1[(this.C0 >> 8) & 255] ^ Tinv2[(this.C3 >> 16) & 255] ^ Tinv3[(this.C2 >> 24) & 255] ^ KW[r][1];
            r2 = Tinv0[this.C2 & 255] ^ Tinv1[(this.C1 >> 8) & 255] ^ Tinv2[(this.C0 >> 16) & 255] ^ Tinv3[(this.C3 >> 24) & 255] ^ KW[r][2];
            r3 = Tinv0[this.C3 & 255] ^ Tinv1[(this.C2 >> 8) & 255] ^ Tinv2[(this.C1 >> 16) & 255] ^ Tinv3[(this.C0 >> 24) & 255] ^ KW[r--][3];
