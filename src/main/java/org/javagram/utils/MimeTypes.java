...
public class MimeTypes {
    ...
    private final static Map<String, List<String>> MIME_TO_EXT = new HashMap<>();
    private final static Map<String, String> EXT_TO_MIME = new HashMap<>();
    
    static {
        for (String[] type : MIME_TYPES) {
            String mimeType = type[0];
            String[] extensions = type[1].split(";");
            MIME_TO_EXT.put(mimeType, Arrays.asList(extensions));
